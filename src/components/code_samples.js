...
var code_samples = {
    ...
    list_of_samples: [{
            ...
            description: `
      This is the full proyect of the software created for the generation
    ...
    `
        },
        {
            ...
            description: `
      Nuxt.js configuration for a site that contains the pipeline
    ...
    `
        },
        {
            ...
            description: `
      Showcase of a quick configuration of Webpack I did for this
      CV.
    `
        }
    ]
